...
class Clippy {
  ...
  static function main() {
    ...
    button.addEventListener(MouseEvent.MOUSE_UP, function(e:MouseEvent) {
      flash.system.System.setClipboard(ExternalInterface.call("(function(id){if(document.getElementById(id)){var el=$('#'+id),val;if(el.is(':input')){return el.val().trim();}else{return el.text().trim();}}else{alert('WARN: ' + id + ' Not found ');}})",id));
